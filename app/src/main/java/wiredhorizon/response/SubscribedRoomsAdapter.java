 ...
 */
public class SubscribedRoomsAdapter extends ArrayAdapter<Room> {
    public SubscribedRoomsAdapter(Context context, int resource, List<Room> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getContext(), RoomSubscriberActivity.class);
